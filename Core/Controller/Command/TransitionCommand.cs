...
// History:
//  5/30/09 KP	Changed the logging to Common.Logging
//  9/29/09 KP	Renamed logging methods to use GetCurrentClassLogger method
//  3/21/11 SD	Changed the call for IsPublished to UsePublishedContent due to the
//				addition of support for publisher rules -- UsePublishedContent includes
//				both IsPublished and rules checks.
//				ShouldBePublished was also moved from ContentProvider to ContentPublisher.

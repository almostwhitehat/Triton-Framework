...
namespace Triton.Controller.Publish
{
	...
	public class PublishConfigSection : ConfigurationSection
	{
		...
		public bool Publish
		{
			get { return ("on".Equals((string) this["mode"], StringComparison.CurrentCultureIgnoreCase)); }
		}
		...
		{
			get { return (PublisherElementCollection) this["publishers"]; }
		}
	...
	public class PublisherElementCollection : ConfigurationElementCollection
	{
		...
		{
			get { return (PublisherElement) BaseGet(Name); }
		}
	...
	public class SettingsElementCollection : ConfigurationElementCollection
	{
		...
		{
			get { return (SettingsElement) BaseGet(index); }
			set
			{
				if (BaseGet(index) != null) {
					BaseRemoveAt(index);
		...
		{
			get { return (SettingsElement) BaseGet(Name); }
		}

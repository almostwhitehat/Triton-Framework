...
#endregion
namespace Triton.Utilities.ChaosIoC
{
	using System;
	...
	#region ChaosIoC Exception Types
	/// <summary>
	/// 
	/// </summary>
	public class ChaosIoCResolutionException : Exception
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCResolutionException"/> class.
		/// </summary>
		/// <param name="type">The type.</param>
		public ChaosIoCResolutionException(Type type)
		...
		public ChaosIoCResolutionException(Type type, Exception innerException)
	...
	/// 
	/// </summary>
	public class ChaosIoCRegistrationTypeException : Exception
	{
		/// <summary>
		/// 
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCRegistrationTypeException"/> class.
		/// </summary>
		/// <param name="type">The type.</param>
		/// <param name="factory">The factory.</param>
		public ChaosIoCRegistrationTypeException(Type type, string factory)
		...
		/// <param name="factory">The factory.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCRegistrationTypeException(Type type, string factory, Exception innerException)
	...
	/// 
	/// </summary>
	public class ChaosIoCRegistrationException : Exception
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCRegistrationException"/> class.
		/// </summary>
		/// <param name="type">The type.</param>
		/// <param name="method">The method.</param>
		public ChaosIoCRegistrationException(Type type, string method)
		...
		/// <param name="method">The method.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCRegistrationException(Type type, string method, Exception innerException)
		...
		public ChaosIoCRegistrationException(Type registerType, Type implementationType)
		...
		/// <param name="implementationType">Type of the implementation.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCRegistrationException(Type registerType, Type implementationType, Exception innerException)
	...
	/// 
	/// </summary>
	public class ChaosIoCWeakReferenceException : Exception
	{
		private const string ERROR_TEXT = "Unable to instantiate {0} - referenced object has been reclaimed";

		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCWeakReferenceException"/> class.
		/// </summary>
		/// <param name="type">The type.</param>
		public ChaosIoCWeakReferenceException(Type type)
			: base(String.Format(ERROR_TEXT, type.FullName))
		{
		}
		...
		/// <param name="type">The type.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCWeakReferenceException(Type type, Exception innerException)
			: base(String.Format(ERROR_TEXT, type.FullName), innerException)
		{
		}
	}
	...
	/// 
	/// </summary>
	public class ChaosIoCConstructorResolutionException : Exception
	{
		private const string ERROR_TEXT = "Unable to resolve constructor for {0} using provided Expression.";

		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCConstructorResolutionException"/> class.
		/// </summary>
		/// <param name="type">The type.</param>
		public ChaosIoCConstructorResolutionException(Type type)
			: base(String.Format(ERROR_TEXT, type.FullName))
		{
		}
		...
		/// <param name="type">The type.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCConstructorResolutionException(Type type, Exception innerException)
			: base(String.Format(ERROR_TEXT, type.FullName), innerException)
		{
		}
		...
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCConstructorResolutionException(string message, Exception innerException)
		...
		/// </summary>
		/// <param name="message">The message.</param>
		public ChaosIoCConstructorResolutionException(string message)
			: base(message)
		{
		}
	}
	...
	/// 
	/// </summary>
	public class ChaosIoCAutoRegistrationException : Exception
	{
		private const string ERROR_TEXT = "Duplicate implementation of type {0} found ({1}).";

		/// <summary>
		/// Initializes a new instance of the <see cref="ChaosIoCAutoRegistrationException"/> class.
		/// </summary>
		/// <param name="registerType">Type of the register.</param>
		/// <param name="types">The types.</param>
		public ChaosIoCAutoRegistrationException(Type registerType, IEnumerable<Type> types)
		...
		/// <param name="types">The types.</param>
		/// <param name="innerException">The inner exception.</param>
		public ChaosIoCAutoRegistrationException(Type registerType, IEnumerable<Type> types, Exception innerException)
	...
	/// 
	/// </summary>
	public sealed class ChaosIoCContainer : IDisposable
	{
		#region "Fluent" API
		/// <summary>
		...
		{
			private ChaosIoCContainer _Container;
			...
			public RegisterOptions(ChaosIoCContainer container, TypeRegistration registration)
			{
			...
			public RegisterOptions AsSingleton()
			{
				...
				if (currentFactory == null)
					throw new ChaosIoCRegistrationException(_Registration.Type, "singleton");
			...
			public RegisterOptions AsMultiInstance()
			{
				...
				if (currentFactory == null)
					throw new ChaosIoCRegistrationException(_Registration.Type, "multi-instance");
			...
			public RegisterOptions WithWeakReference()
			{
				...
				if (currentFactory == null)
					throw new ChaosIoCRegistrationException(_Registration.Type, "weak reference");
			...
			public RegisterOptions WithStrongReference()
			{
				...
				if (currentFactory == null)
					throw new ChaosIoCRegistrationException(_Registration.Type, "strong reference");
			...
			public RegisterOptions UsingConstructor<RegisterType>(Expression<Func<RegisterType>> constructor)
			{
				...
				if (lambda == null)
					throw new ChaosIoCConstructorResolutionException(typeof(RegisterType));
			...
			/// <returns>RegisterOptions</returns>
			public static RegisterOptions ToCustomLifetimeManager(RegisterOptions instance, IChaosIoCObjectLifetimeProvider lifetimeProvider, string errorString)
			{
				if (instance == null)
				...
				if (currentFactory == null)
					throw new ChaosIoCRegistrationException(instance._Registration.Type, errorString);
		...
		public ChaosIoCContainer GetChildContainer()
		{
			return new ChaosIoCContainer(this);
		}
		#endregion
		...
		/// <exception cref="ChaosIoCAutoRegistrationException"/>
		...
		/// <returns>RegisterOptions for fluent API</returns>
		public RegisterOptions Register<RegisterType>(Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType> factory)
			where RegisterType : class
		{
		...
		/// <returns>RegisterOptions for fluent API</returns>
		public RegisterOptions Register<RegisterType>(Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType> factory, string name)
			where RegisterType : class
		{
		...
		/// <exception cref="ChaosIoCResolutionException">Unable to resolve the type.</exception>
		...
		public bool TryResolve(Type resolveType, out object resolvedType)
		{
			...
			catch (ChaosIoCResolutionException)
			{
				resolvedType = null;
				return false;
			}
		...
		/// </summary>
		public interface IChaosIoCObjectLifetimeProvider
		{
			/// <summary>
		...
		private abstract class ObjectFactoryBase
		{
			...
			/// <returns></returns>
			public abstract object GetObject(ChaosIoCContainer container, NamedParameterOverloads parameters, ResolveOptions options);

			public virtual ObjectFactoryBase SingletonVariant
			{
				get
				{
					throw new ChaosIoCRegistrationException(this.GetType(), "singleton");
				}
			}
			...
			public virtual ObjectFactoryBase MultiInstanceVariant
			{
				get
				{
					throw new ChaosIoCRegistrationException(this.GetType(), "multi-instance");
				}
			}
			...
			public virtual ObjectFactoryBase StrongReferenceVariant
			{
				get
				{
					throw new ChaosIoCRegistrationException(this.GetType(), "strong reference");
				}
			}
			...
			public virtual ObjectFactoryBase WeakReferenceVariant
			{
				get
				{
					throw new ChaosIoCRegistrationException(this.GetType(), "weak reference");
				}
			}

			public virtual ObjectFactoryBase GetCustomObjectLifetimeVariant(IChaosIoCObjectLifetimeProvider lifetimeProvider, string errorString)
			{
				throw new ChaosIoCRegistrationException(this.GetType(), errorString);
			}
			...
			public virtual ObjectFactoryBase GetFactoryForChildContainer(ChaosIoCContainer parent, ChaosIoCContainer child)
			{
				return this;
			}
		}
			...
			where RegisterImplementation : class, RegisterType
		{
			...
			public MultiInstanceFactory()
			{
				if (typeof(RegisterImplementation).IsAbstract || typeof(RegisterImplementation).IsInterface)
					throw new ChaosIoCRegistrationTypeException(typeof(RegisterImplementation), "MultiInstanceFactory");
			}

			public override object GetObject(ChaosIoCContainer container, NamedParameterOverloads parameters, ResolveOptions options)
			{
				try
				{
					return container.ConstructType(typeof(RegisterImplementation), Constructor, parameters, options);
				}
				catch (ChaosIoCResolutionException ex)
				{
					throw new ChaosIoCResolutionException(typeof(RegisterImplementation), ex);
				}
			}
			...
			public override ObjectFactoryBase GetCustomObjectLifetimeVariant(IChaosIoCObjectLifetimeProvider lifetimeProvider, string errorString)
			{
		...
		private class DelegateFactory<RegisterType> : ObjectFactoryBase
			where RegisterType : class
		{
			private Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType> _factory;
			...
			public override object GetObject(ChaosIoCContainer container, NamedParameterOverloads parameters, ResolveOptions options)
			{
				...
				{
					throw new ChaosIoCResolutionException(typeof(RegisterType), ex);
				}
			}

			public DelegateFactory(Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType> factory)
			{
				if (factory == null)
			...
			{
				throw new ChaosIoCConstructorResolutionException("Constructor selection is not possible for delegate factory registrations");
			}
		}
			...
			where RegisterType : class
		{
			...
			public override object GetObject(ChaosIoCContainer container, NamedParameterOverloads parameters, ResolveOptions options)
			{
				var factory = _factory.Target as Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType>;

				if (factory == null)
					throw new ChaosIoCWeakReferenceException(typeof(RegisterType));
			...
			public WeakDelegateFactory(Func<ChaosIoCContainer, NamedParameterOverloads, RegisterType> factory)
			{
				if (factory == null)
					throw new ArgumentNullException("factory");
			...
			where RegisterImplementation : class, RegisterType
		{
			...
			public override void SetConstructor(ConstructorInfo constructor)
			{
				throw new ChaosIoCConstructorResolutionException("Constructor selection is not possible for instance factory registrations");
			}
			...
			where RegisterImplementation : class, RegisterType
		{
			...
			{
				if (typeof(RegisterImplementation).IsAbstract || typeof(RegisterImplementation).IsInterface)
					throw new ChaosIoCRegistrationTypeException(typeof(RegisterImplementation), "SingletonFactory");
			}
			...
			public override ObjectFactoryBase GetFactoryForChildContainer(ChaosIoCContainer parent, ChaosIoCContainer child)
			{
		...
		{
			private readonly object SingletonLock = new object();
			private readonly IChaosIoCObjectLifetimeProvider _LifetimeProvider;

			public CustomObjectLifetimeFactory(IChaosIoCObjectLifetimeProvider lifetimeProvider, string errorMessage)
			{
				if (lifetimeProvider == null)
					throw new ArgumentNullException("lifetimeProvider", "lifetimeProvider is null.");

				if (typeof(RegisterImplementation).IsAbstract || typeof(RegisterImplementation).IsInterface)
					throw new ChaosIoCRegistrationTypeException(typeof(RegisterImplementation), errorMessage);
		...
		private static readonly ChaosIoCContainer _Current = new ChaosIoCContainer();

		static ChaosIoCContainer()
		{
		}
		...
		/// </summary>
		public static ChaosIoCContainer Current
		{
			get
			{
				return _Current;
		...
		ChaosIoCContainer _Parent;
		private ChaosIoCContainer(ChaosIoCContainer parent)
			: this()
		{
			_Parent = parent;
		}
			...
			lock (_AutoRegisterLock)
			{
				...
				foreach (var type in abstractInterfaceTypes)
				{
					...
					if (!ignoreDuplicateImplementations && implementations.Count() > 1)
						throw new ChaosIoCAutoRegistrationException(type, implementations);
		...
		{
			Register<ChaosIoCContainer>(this);
		...
		private object ResolveInternal(TypeRegistration registration, NamedParameterOverloads parameters, ResolveOptions options)
		{
			...
			if (_RegisteredTypes.TryGetValue(registration, out factory))
			{
				...
				{
					throw new ChaosIoCResolutionException(registration.Type, ex);
				}
			}
			...
			if (!String.IsNullOrEmpty(registration.Name) && options.NamedResolutionFailureAction == NamedResolutionFailureActions.Fail)
				throw new ChaosIoCResolutionException(registration.Type);
		...
		private object GetLazyAutomaticFactoryRequest(Type type)
		{
			...
			if (genericType == typeof(Func<>))
			{
				...
				MethodInfo resolveMethod = typeof(ChaosIoCContainer).GetMethod("Resolve", new Type[] { });
			...
			if ((genericType == typeof(Func<,>)) && (genericArguments[0] == typeof(string)))
			{
				...
				MethodInfo resolveMethod = typeof(ChaosIoCContainer).GetMethod("Resolve", new Type[] { typeof(String) });
				resolveMethod = resolveMethod.MakeGenericMethod(returnType);
			...
			if ((genericType == typeof(Func<,,>) && type.GetGenericArguments()[0] == typeof(string) && type.GetGenericArguments()[1] == typeof(IDictionary<string, object>)))
			{
				...
				MethodInfo resolveMethod = typeof(ChaosIoCContainer).GetMethod("Resolve", new Type[] { typeof(String), typeof(NamedParameterOverloads) });
				resolveMethod = resolveMethod.MakeGenericMethod(returnType);
			...
			throw new ChaosIoCResolutionException(type);
		}
#endif
...
//#endif
		...
		private object ConstructType(Type type, ConstructorInfo constructor, NamedParameterOverloads parameters, ResolveOptions options)
		{
			...
			{
				throw new ChaosIoCResolutionException(type, ex);
			}
		}
		...
		private RegisterOptions ExecuteGenericRegister(Type[] genericParameterTypes, Type[] methodParameterTypes, object[] methodParameters)
		{
			...
			catch (ArgumentException ex)
			{
				...
				throw new ChaosIoCRegistrationException(registrationType, implementationType, ex);
			}
		}
		#endregion

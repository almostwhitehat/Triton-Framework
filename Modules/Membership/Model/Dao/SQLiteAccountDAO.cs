...
namespace web.security.membership.model.dao {
	...
	public class SQLiteAccountDAO : web.model.dao.SQLiteDAOBase, AccountDAO
	{
			...
			Guid accountId)
		{
			...
			try {
				...
				logger.Error("SQLiteAccountDAO:GetAccount(Guid): ", e);
			}
			finally {
			...
			string userName)
		{
			...
			*/
			...
			try {
				...
				logger.Error("SQLiteAccountDAO:GetAccount(string): ", e);
			} finally {
				DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
			}
            ...
            Guid accountId)
        {
            ...
            {
                logger.Error("SQLiteAccountDAO::GetUsernames: ", e);
            }
            finally
            {
                DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
			...
			Guid accountId)
		{
			...
			try {
				...
				logger.Error("SQLiteAccountDAO::GetAttributes: ", e);
			} finally {
				DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
			}
			...
			Guid accountId)
		{
			...
			try {
				...
				logger.Error("SQLiteAccountDAO::GetAddresses: ", e);
			} finally {
				DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
			}
		...
		private class DAOCommand
		{
            ...
            public DAOCommand(SQLiteConnection conn)
			{
				this.conn = conn;
			}
			...
			public void ExecuteCommand()
			{
				...
				try {
					...
					try {
						...
						//logger.Error("SQLiteAccountDAO::DAOCommand:ExecuteCommand: ", e);
						//trans.Rollback();
						throw ex;
					}
					
				} catch (Exception e) {
					logger.SevereError("SQLiteAccountDAO::DAOCommand:ExecuteCommand: ", e);
					throw e;
				} finally {
        ...
        public Role GetRole(int Id)
        {
            ...
            {
                logger.Error("SQLiteAccountDAO::GetRole(int): ", e);
            }
            finally
            {
                DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
...
//                  join member_role mr on mr.role_id = mar.role_id 
        ...
        public int InsertRole(Role role)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "insert into Member_Role (" + fieldsSql.ToString() + ")" +
                                " values (" + valuesSql.ToString() + "); Select last_insert_rowid()";
            ...
            {
                logger.Error("SQLiteAccountDAO::InsertRole: ", e);
        ...
        public int UpdateRole(Role role)
        {
            ...
            {
                logger.Error("SQLiteAccountDAO::UpdateRole: ", e);
        ...
        private bool InsertAccount2Contact( Guid accountId, int contactId) {
            ...
            try
            {
                ...
                logger.Error("SQLiteAccountDAO::InsertAccount2Contact: ", e);
        ...
        public bool AddRoleToAccount(Account account, Role role) {
            ...
            try
            {
                ...
                logger.Error("SQLiteAccountDAO::InsertAccount2Role: ", e);
                throw new Exception("Unable to create Contact.");
            }
            finally {
                DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
        ...
        private bool InsertAccount2Address (Guid accountId,int addressTypeId, int addressId) {
            ...
            {
                logger.Error("SQLiteAccountDAO::InsertAccount2Address: ", e);
        ...
        public bool UpdateAccountStatus(Guid uid, AccountStatus newStatus)
        {
            ...
            {
                logger.Error("SQLiteAccountDAO:UpdateAccountStatus: ", e);
            }
            finally
            {
                DbUtil.close((cmd == null) ? null : cmd.Connection, cmd, dr);
